...
A living charter for building intelligence that walks, sees, lights, and acts in the real world.
...
Signed,
The Architects of Embodied Intelligence
```

## Response snapshot

Created a comprehensive constitution for the Physical AI & Humanoid Robotics program based on the provided content. The constitution replaces the template placeholders with the detailed articles and principles for the program, including:

- The mission and philosophy of Physical AI
- Four learning pillars (ROS 2, Digital Twin, AI-Robot Brain, Vision-Language-Action)
- Student covenant and capstone mandate
- Infrastructure rights and ethics guidelines
...
- ✅ Impact: Created comprehensive constitution for Physical AI & Humanoid Robotics program
- 🧪 Tests: none
- 📁 Files: Updated .specify/memory/constitution.md
- 🔁 Next prompts: Continue with program implementation based on constitution
- 🧠 Reflection: The constitution provides a strong foundation for the program with clear principles and governance
